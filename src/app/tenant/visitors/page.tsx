...
import { UserCheck, Plus, Loader, Clock, CheckCircle2, Search } from 'lucide-react';
...
export default function TenantVisitors() {
  ...
  return (
    <div className="space-y-7 page-entrance text-left font-sans transition-colors duration-200">
      ...
      {/* 📜 2. VISITOR PASS CARDS GRID / EMPTY STATE */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {visitors.length === 0 ? (
          <div className="col-span-full p-12 text-center bg-[#FFFDF9] dark:bg-[#141D19] rounded-[32px] border border-[#DDD8CE] dark:border-[#293832] text-[#68736E] dark:text-[#9BAAA4] space-y-3">
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-3.5">
                    <div className="w-11 h-11 rounded-2xl tenant-bg-accent font-black flex items-center justify-center text-base shadow-sm shrink-0">
                ...
                <div className="space-y-2 bg-[#F1EEE7] dark:bg-[#1A2621] p-4 rounded-2xl border border-[#DDD8CE] dark:border-[#293832] text-xs font-bold text-[#68736E] dark:text-[#9BAAA4]">
